...
import { IExcelData, defaultValue } from 'app/shared/model/excel-file.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXCELDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXCELDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXCELDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXCELDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXCELDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXCELDATA actions', async () => {
      const expectedActions = [
        {
