...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MASTERCIRCUIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_MASTERCIRCUIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MASTERCIRCUIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MASTERCIRCUIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MASTERCIRCUIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MASTERCIRCUIT actions', async () => {
      const expectedActions = [
        {
