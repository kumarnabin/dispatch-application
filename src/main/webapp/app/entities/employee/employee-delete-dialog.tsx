...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dispatchApplicationApp.employee.delete.question">
        <Translate contentKey="dispatchApplicationApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
