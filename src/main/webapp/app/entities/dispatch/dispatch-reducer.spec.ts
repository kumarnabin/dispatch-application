...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dispatch.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISPATCH_LIST actions', async () => {
    ...
    it('dispatches FETCH_DISPATCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DISPATCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DISPATCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DISPATCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DISPATCH actions', async () => {
      const expectedActions = [
        {
