...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './olt.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OLT_LIST actions', async () => {
    ...
    it('dispatches FETCH_OLT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OLT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OLT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OLT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OLT actions', async () => {
      const expectedActions = [
        {
