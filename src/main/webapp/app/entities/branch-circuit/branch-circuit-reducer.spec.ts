...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BRANCHCIRCUIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_BRANCHCIRCUIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BRANCHCIRCUIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BRANCHCIRCUIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BRANCHCIRCUIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BRANCHCIRCUIT actions', async () => {
      const expectedActions = [
        {
