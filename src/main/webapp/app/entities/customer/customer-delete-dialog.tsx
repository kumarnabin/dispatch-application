...
export const CustomerDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dispatchApplicationApp.customer.delete.question">
        <Translate contentKey="dispatchApplicationApp.customer.delete.question" interpolate={{ id: customerEntity.id }}>
