...
export const BranchDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dispatchApplicationApp.branch.delete.question">
        <Translate contentKey="dispatchApplicationApp.branch.delete.question" interpolate={{ id: branchEntity.id }}>
