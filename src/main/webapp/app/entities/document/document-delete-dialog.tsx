...
export const DocumentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dispatchApplicationApp.document.delete.question">
        <Translate contentKey="dispatchApplicationApp.document.delete.question" interpolate={{ id: documentEntity.id }}>
