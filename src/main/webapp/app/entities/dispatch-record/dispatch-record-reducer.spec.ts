...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISPATCHRECORD_LIST actions', async () => {
    ...
    it('dispatches FETCH_DISPATCHRECORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DISPATCHRECORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DISPATCHRECORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DISPATCHRECORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DISPATCHRECORD actions', async () => {
      const expectedActions = [
        {
