...
public class ExcelDataResource {
    ...
    public ResponseEntity<ExcelDataDTO> updateExcelData(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, excelDataDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<ExcelDataDTO> partialUpdateExcelData(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, excelDataDTO.getId().toString())
        );
    }
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<ExcelDataDTO>> getAllExcelData(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of ExcelData");
        Page<ExcelDataDTO> page = excelDataService.findAll(pageable);
