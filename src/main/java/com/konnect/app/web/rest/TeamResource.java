...
import com.konnect.app.service.TeamService;
...
/**
 * REST controller for managing {@link com.konnect.app.domain.Team}.
 */
@RestController
...
public class TeamResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<TeamDTO>> getAllTeams(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
