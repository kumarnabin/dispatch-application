...
public class EmployeeAreaService {
    ...
    public List<EmployeeAreaDTO> findAll() {
        log.debug("Request to get all EmployeeAreas");
        return employeeAreaRepository.findAll().stream().map(employeeAreaMapper::toDto).collect(Collectors.toCollection(LinkedList::new));
    }
